...
for vlan in sorted(switches["fqdr-core-1"]["vlans"]):
  a = sorted(switches["fqdr-core-1"]["names"])
...
#      for vlan in switches["rd-core-1"]["vlans"][vlan]:
#        vlan = list(vlan.split(':'))
#        vlan = vlan[0]
#        if vlan not in switches["fqdr-core-1"]["vlans"][vlan]:
